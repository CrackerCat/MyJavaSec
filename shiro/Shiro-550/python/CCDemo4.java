...
/**
 * Use JDK 8u131 And CommonsCollections4
 */
public class CCDemo4 {
    ...
    public static void main(String[] args) {
        try {
            ...
            FileOutputStream baos = new FileOutputStream(new File("./CCDemo4.txt"));
            ObjectOutputStream oos = new ObjectOutputStream(baos);
            oos.writeObject(priorityQueue);
            oos.flush();
            oos.close();

            FileInputStream bais = new FileInputStream(new File("./CCDemo4.txt"));
